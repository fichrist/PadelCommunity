...
const SignupCard = ({ open, onOpenChange }: SignupCardProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle className="text-xl font-semibold font-comfortaa">
            Join Our Padel Community
          </DialogTitle>
          <DialogDescription className="text-base">
            {isLogin
              ? "Welcome back! Sign in to your account"
              : "Create an account to find matches and post open matches"
            }
          </DialogDescription>
        </DialogHeader>
