...
# Update pooler URL
Set-Content -Path ".temp/pooler-url" -Value "postgresql://postgres.djnljqrarilsuodmetdl:IRQK9iKcScvi44en@aws-0-eu-west-1.pooler.supabase.com:6543/postgres"
...
Write-Host ""
Write-Host "Now you can run: npx supabase db push --password IRQK9iKcScvi44en" -ForegroundColor Yellow
